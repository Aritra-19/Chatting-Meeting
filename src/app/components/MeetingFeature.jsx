    ...
    <div className="flex flex-col items-center">
      <div className="relative">
        ...
        <Button
          ...
          size={"icon"}
          className={
            "absolute top-1/2 -left-10 transform -translate-y-1/2 -translate-x-full"
          }
          onClick={prevSlide}
        >
        ...
        <Button
          ...
          size={"icon"}
          className={
            "absolute top-1/2 -right-10 transform -translate-y-1/2 translate-x-full"
          }
          onClick={nextSlide}
        >
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 text-center text-gray-900 dark:text-white">
      ...
      <div className="flex justify-center space-x-2 mt-4">
        {slides.map((_,index) => (
          <div key={index} className={`w-3 h-3 rounded-full ${index === currentSlide ? 'bg-blue-600' : 'bg-gray-300'}`}></div>
        ))}
      </div>
    </div>
  );
