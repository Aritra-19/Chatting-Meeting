...
const page = () => {
  ...
  const url = process.env.NEXT_PUBLIC_CALLBACK_URL;
  ...
  const handleLogin = async (Provider) => {
    ...
    try {
      ...
      toast.info(`Login successful: ${Provider}`);
    } catch (error) {
      ...
      <div className="flex flex-col justify-center w-full p-8 lg:w-1/2">
        <div className="max-w-md mx-auto">
          <h1 className="mb-4 text-3xl font-bold">
            Welcome to Chatting-Meeting
          </h1>
          <p className="mb-8 text-gray-600 dark:text-gray-100">
            Connect with your team and friends through video calls and meetings
            anytime, anywhere. Join or create a meeting in seconds with
          ...
          <div className="flex flex-col space-y-4 mt-6">
            <div className="relative w-full">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-black dark:text-white">
                  or
                </span>
              </div>
            </div>
            <Button
              className="w-full bg-black text-white dark:hover:bg-gray-400 dark:bg-white dark:text-black"
              variant="ghost"
